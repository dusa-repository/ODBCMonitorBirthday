...
Module Principal
    ...
    Private Sub monitorear()
        ...
        ejecutarSQL("delete from empleado")
        ...
        Try
            ...
            Using sr As New StreamReader("FNM079.txt")
                ...
                While sr.Read
                    ...
                    ejecutarSQL("insert into empleado values('" + Trim(s(0)) + "','" + Trim(s(1)) + "','" + Trim(s(2)) + "','" + Trim(s(3)) + "','" + Trim(s(4)) + "','" + Trim(s(5)) + "','" + Trim(s(6)) + "',convert(datetime,'" + Right(Trim(s(7)), 2) & "/" & Mid(Trim(s(7)), 5, 2) & "/" & Left(Trim(s(7)), 4) + "',103),convert(datetime,'" & Right(Trim(s(8)), 2) & "/" & Mid(Trim(s(8)), 5, 2) & "/" & Left(Trim(s(8)), 4) & "',103))")
                End While
            End Using
        Catch ex As Exception
            escribirLog(ex.Message.ToString, "(PO) ")
